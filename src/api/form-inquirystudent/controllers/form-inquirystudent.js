...
module.exports = createCoreController('api::form-inquirystudent.form-inquirystudent',({ strapi }) => ({
    async sendEmail(ctx) {
        try {
...
async function saveContactToDatabase(data) {
  return await strapi.db.query("api::form-inquirystudent.form-inquirystudent").create({ data });
}
