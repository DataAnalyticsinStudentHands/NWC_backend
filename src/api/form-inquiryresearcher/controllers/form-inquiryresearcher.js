...
module.exports = createCoreController('api::form-inquiryresearcher.form-inquiryresearcher',({ strapi }) => ({
    async sendEmail(ctx) {
        try {
...
async function saveContactToDatabase(data) {
  return await strapi.db.query("api::form-inquiryresearcher.form-inquiryresearcher").create({ data });
}
