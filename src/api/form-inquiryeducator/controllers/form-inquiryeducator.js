...
module.exports = createCoreController('api::form-inquiryeducator.form-inquiryeducator',({ strapi }) => ({
    async sendEmail(ctx) {
        try {
...
async function saveContactToDatabase(data) {
  return await strapi.db.query("api::form-inquiryeducator.form-inquiryeducator").create({ data });
}
