...
module.exports = createCoreController('api::form-inquiryarchivist.form-inquiryarchivist',({ strapi }) => ({
    async sendEmail(ctx) {
        try {
...
async function saveContactToDatabase(data) {
  return await strapi.db.query("api::form-inquiryarchivist.form-inquiryarchivist").create({ data });
}
